...
function MessageButtons() {
  ...
  const buttonsRedux = useAppSelector(
    (state) => state.templateBuilder.specific_template.buttons,
  );
  {
    /*Manage Button Changes */
  }
  //checked variable for open/close header, default to to show header
  const [openButtons, setOpenButtons] = useState<boolean>(true);
  ...
  const handleUpdateButtonValues = (
    index: number,
      ...
      >
        ...
        >
          ...
          >
            <Switch
              checked={openButtons}
              onChange={() => setOpenButtons(!openButtons)}
                ...
                >
                  ...
                  >
                    ...
                    <TextField
                      ...
                      onChange={(e) => handleUpdateButtonValues(index, e)}
                      inputProps={{
                        /*max chars */
                        maxLength: 25,
                      }}
